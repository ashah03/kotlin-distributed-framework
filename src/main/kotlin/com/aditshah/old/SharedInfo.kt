...
//    val locationMap: ConcurrentMap<Int, com.aditshah.distributed.infrastructure.common.Coordinate> = Maps.newConcurrentMap()
//    val weightsMap: ConcurrentMap<com.aditshah.distributed.infrastructure.common.Coordinate, Double> = Maps.newConcurrentMap()
//
//    fun toJson(): String {
...
//    fun actionInRadiusInt(radius : Double, center : com.aditshah.distributed.infrastructure.common.Coordinate, block : ( )->Unit ){
